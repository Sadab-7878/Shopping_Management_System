           ...
           while($row = mysqli_fetch_assoc($result)){
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-success"><a href="pupdate.php?updateid='.$W_ID.'" class="text-light">Update</a></button>
                      
                      <button  class="btn btn-danger"><a href="pdelete.php?deleteid='.$W_ID.'" class="text-light">Delete</a></button>
